...
export const sectionsData = [
  {
    id: 'micro-frontend',
    technologies: [
      'React', 'TypeScript', 'Webpack Module Federation', 'Micro Frontend',
      'Meta AppShell', 'React Router', 'JWT Authentication',
  ...
  },
  {
    id: 'microservices',
    technologies: [
      'ASP.NET Core', 'C#', 'Microservices', 'YARP API Gateway',
      'gRPC', 'RabbitMQ', 'PostgreSQL', 'Entity Framework Core',
      'JWT Authentication', 'Database per Service', 'Docker'
    ],
    items: [
  ...
  },
  {
    id: 'desktop-suite',
    technologies: [
      'C#', '.NET Framework', 'Windows Forms', 'Microsoft SQL Server',
      'Entity Framework', 'Dapper', 'Repository Pattern', 'Unit of Work Pattern',
      'Factory Pattern', 'Singleton Pattern', 'Strategy Pattern', 'Facade Pattern',
      'Observer Pattern', 'Command Pattern', 'Dependency Injection',
      'SOLID Principles', 'Object-Oriented Programming (OOP)',
      'Stimulsoft Reports', 'DevComponents DotNetBar'
    ],
    items: [
  ...
  },
  {
    ...
    technologies: [
      ...
      'Feature-Based Architecture', 'Tailwind CSS', 'NextAuth.js',
      'NestJS', 'Domain-Driven Design (DDD)', 'Clean Architecture',
      'REST API', 'PostgreSQL', 'TypeORM', 'Redis', 'RabbitMQ', 'Docker'
    ],
    items: [
